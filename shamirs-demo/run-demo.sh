...
"${MAVEN_REPO}"/org/scala-lang/scala3-library_3/3.1.0/scala3-library_3-3.1.0.jar:\
...
"${MAVEN_REPO}"/org/bouncycastle/bcpkix-jdk15on/1.70/bcpkix-jdk15on-1.70.jar:\
"${MAVEN_REPO}"/org/bouncycastle/bcprov-jdk15on/1.70/bcprov-jdk15on-1.70.jar:\
"${MAVEN_REPO}"/org/bouncycastle/bcutil-jdk15on/1.70/bcutil-jdk15on-1.70.jar:\
